...
int pb_api_auth_set_otp_password(struct pb_context *ctx, const char *password, size_t size);
...
int pb_api_boot_ram(struct pb_context *ctx, const void *bpak_image, uint8_t *uuid, bool verbose);
