...
class Session(object):
    ...
    def __init__(self, device_uuid: Optional[uuid.UUID | str | None] = None):
        ...
        self._s = _punchboot.Session(_device_uuid)
    ...
    def boot_partition(self, part: uuid.UUID | str):
        """Boot partition.
        ...
        """
        _uu: uuid.UUID = uuid.UUID(part) if isinstance(part, str) else part
        self._s.boot_partition(_uu.bytes)
    ...
    def device_get_punchboot_version(self) -> semver.Version:
        ...
        return semver.VersionInfo.parse(self._s.device_get_punchboot_version())
    ...
    def slc_set_configuration_locked(self):
        """Set SLC to configuration locked.

        Warning: This ususally means writing fuses, this operation might
        brick your device.
        """
        self._s.slc_set_configuration_locked()
